...
//                  onPressed: () => _handleSubmmited(_textController.text)),
                  onPressed: () {
                    return _handleSubmmited(_textController.text);
                  }),
            ),
          ],
        )
...
//                );
              ...
              child: new Text(
                  'RaisedButton', style: new TextStyle(color: Colors.white)),
            ),
            new FlatButton(
              onPressed: (){},
              color: Colors.blue[400],
              child: new Text('FlatButton',style: new TextStyle(color: Colors.white)),
            ),
            _buildTextComposer(),
          ],
        ),
